...
public class NewsFragment extends BaseFragment {
    ...
    private void getData(boolean first) {
        new IMessageImpl().getNews(new IMessage.OnGetMessageListListener() {
            @Override
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new BaseQuickAdapter<MessageModel>(R.layout.news_item, mDatas) {
            @Override
            protected void convert(BaseViewHolder baseViewHolder, MessageModel messageModel) {
                ...
                SimpleDraweeView simpleDraweeView = baseViewHolder.getView(R.id.news_item_cover_img);
                simpleDraweeView.setImageURI(messageModel.getCoverImage());
            }
        };
        mAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            @Override
            public void onItemClick(View view, int i) {
                NewsDetailActivity.start(getActivity(), mDatas.get(i).getSourceUrl());
            }
        });
